  ...
  return (
    <section className="hero">
      ...
      <div className={`hero-logo-right ${loaded ? 'hero-logo-right-visible' : ''}`}>
        <img src={`${import.meta.env.BASE_URL}logo.png`} alt="Roots Logo" style={{ width: 'auto', height: 'auto' }} />
      </div>
  ...
  return (
    <section ref={ref} className="newsletter">
      <div className={`newsletter-content ${inView ? 'newsletter-content-visible' : ''}`}>
        <img src={`${import.meta.env.BASE_URL}logo.png`} alt="Roots Logo" style={{ width: '40px', height: 'auto' }} />
